...
use secret_macros::{InvisibleSideEffectFreeDerive, InvisibleSideEffectFreeDeriveEnum};
...
#[derive(PartialEq, Eq, Copy, Clone, Debug, Hash, InvisibleSideEffectFreeDeriveEnum)]
