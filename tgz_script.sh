...
bsdtar -czvf carapace-code.tar.gz.nosync \
    ...
    --exclude=servo-*.nosync/.gitignore \
    --exclude=servo-*.nosync/.gitmodules \
    --exclude=servo-*.nosync/.git \
    --exclude=servo-*.nosync/.github \
    --exclude=servo-*.nosync/target \
    --exclude=servo-*.nosync/info*/.gitignore \
    --exclude=servo-*.nosync/info*/.gitmodules \
    --exclude=servo-*.nosync/info*/.git \
    --exclude=servo-*.nosync/info*/.github \
    ...
    --exclude=servo-*.nosync/.gitignore \
    --exclude=servo-*.nosync/.gitmodules \
    --exclude=servo-*.nosync/python/_virtualenv3.9 \
    --exclude=servo.nosync/.git \
    --exclude=servo.nosync/.github \
    --exclude=servo.nosync/target \
    --exclude=servo.nosync/python/_virtualenv3.9 \
